                            ...
                            <div className="input-container">
                             ...
                             <div className="input-container">
                              ...
                              <div className="input-container">
                                        ...
                                        <input className="inputLogin" type="password" name="password" placeholder="Repeat Password" required />
         
                              </div>
                

                                           <input  className="space-bot inputLogin" type="submit" value="Register" />
